...
app
  ...
  .put((req, res) => {
    Article.replaceOne({ title: req.params.articlesTitle }, { title: req.body.title, content: req.body.content }, { overwrite: true }, (err) => {
      if (!err) {
  ...
  .patch((req, res) => {
    Article.updateOne({ title: req.params.articlesTitle }, { $set: req.body }, (req, res) => {
      if (!err) {
